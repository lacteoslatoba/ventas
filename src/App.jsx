...
const MobileHeader = ({ currentUser, isSyncing, location, navigate }) => {
  ...
  return (
    <div className="md:hidden flex-shrink-0 flex items-center justify-between bg-cheese-100 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-4 py-3 no-print z-40 relative">
...
const BottomNavigation = () => {
  ...
  return (
    <div className="md:hidden flex-none bg-cheese-100 dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 flex justify-around items-center px-4 h-[72px] pb-safe z-10 select-none no-print shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
